...
/** @var frontend\models\searches\ServicesSearch $searchModel */
        ...
        <div class="block-header block-header-default">
          ...
          <?=  Html::customButton([
            ...
            'appearence' => [
              ...
              'theme' => 'primary',
              'visible' => Yii::$app->user->can('frontend-services-create', true)
            ],
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
                ...
                'visibleButtons' => [
                    'update' => Yii::$app->user->can('frontend-services-update',true),
                    'trash' => function ($model){
                         return $model->is_deleted !== 1 ? 
                                Yii::$app->user->can('frontend-services-delete',true) : 
                                Yii::$app->user->can('frontend-services-restore',true);
                    },
                ],
            ],
        ],
